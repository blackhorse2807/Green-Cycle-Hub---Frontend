                    ...
                    {user?.isDocumentVerified ? (
                      ...
                      <div className="w-full">
                        ...
                        >
                          ...
                          {user ? 'Verify Your Account to Send Enquiry' : ' Create an Account to Send Enquiry'}
                        </button>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                <div className="text-3xl font-bold text-green-600">
                  {convertPrice(price)} <span className="text-lg text-gray-500">/ {unit}</span>
                </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-start gap-2">
                    <div>
                      ...
                      <p className="text-blue-800 text-sm mt-1">{additionalNotes}</p>
                    </div>
                  </div>
                </div>
              )}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-4 hover:shadow-md transition-shadow">
                  <div className="flex items-center gap-3">
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">{sourceMaterial}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-4 hover:shadow-md transition-shadow">
                  <div className="flex items-center gap-3">
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">{batchSize}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-4 hover:shadow-md transition-shadow">
                  <div className="flex items-center gap-3">
                    <div>
                      <p className="text-sm text-gray-500">Minimum Order Qty</p>
                      <p className="font-semibold text-gray-900">{minimumOrderQuantity}</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900 text-lg">{sellerUser.name}</p>
                  </div>
                </div>
{/* 
                <div className="flex items-center gap-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{businessDesc}</p>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{sellerUser.address}</p>
                  </div>
                </div>
