...
import { Bell, Search, Filter, Clock, Package, CheckCircle, XCircle, Trash2, Edit, Plus } from "lucide-react";
  ...
  return (
    <div className="text-center py-16">
      ...
      <p className="text-gray-500 max-w-sm mx-auto">
        When you have product updates and activities, they will appear here to keep you informed.
      </p>
    </div>
  );
}
...
export default function NotificationsPanel() {
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      isRead: false,
      createdAt: "2025-06-11T11:32:04.118Z",
      product: {
        id: 45,
        name: "Premium LDPE Pellets"
      }
    },
    {
      id: 2,
      ...
      isRead: true,
      createdAt: "2025-06-10T09:15:30.000Z",
      product: {
        id: 42,
        name: "High-Grade PVC Resin"
      }
    },
    {
      id: 3,
      ...
      isRead: false,
      createdAt: "2025-06-09T16:45:12.000Z",
      product: {
        id: 38,
        name: "Industrial Polyethylene"
      }
    }
  ]);
  ...
  const filtered = notifications.filter((n) => {
    ...
    const matchesId =
      idFilter === "" ||
      (n.productId !== null &&
        n.productId.toString().includes(idFilter));
    const matchesAction =
      actionFilter === "" || n.type === actionFilter;
  ...
  return (
    <div className="min-h-screen max-w-4xl mx-auto p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Stay updated with your product activities and status changes</p>
      </div>
