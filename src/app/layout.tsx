...
export default function RootLayout({ children }: { children: ReactNode }) {
  ...
  const hideFooter = pathname.startsWith('/admin/dashboard') || pathname.startsWith('/seller/dashboard') || pathname.startsWith('/buyer/dashboard') || pathname.startsWith('/chats');
