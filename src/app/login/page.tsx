...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!success) {
        setInvalidCredsError("Invalid email or password. Please verify your email and try again.");
      }
      ...
      >
        ...
        <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-sm font-medium text-[#027e3f] hover:text-[#026e37] transition-colors duration-200">
                Forgot password?
              </a>
            </div>
          ...
          >
            ...
            Don&apos;t have an account?{" "}
                <a href="/register" className="font-medium text-[#027e3f] hover:text-[#026e37] transition-colors duration-200">
                  Create one
            </a>
              </span>
        </div>
