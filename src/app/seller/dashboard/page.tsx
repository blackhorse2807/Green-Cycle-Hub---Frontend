  ...
  useEffect(() => {
    ...
    if (editingProduct) {
      setFormData({
        ...
        minimum_order_quantity: editingProduct.product_minimum_order_quantity.toString() || "",
              ...
              editingProduct={
                editingProduct
                  ? {
                      ...
                      product_source_material: editingProduct.product_source_material,
                      product_batch_size: editingProduct.product_batch_size,
                      product_minimum_order_quantity: editingProduct.product_minimum_order_quantity,
                      product_application: editingProduct.product_application,
                      product_desc: editingProduct.product_desc,
                      product_additional_notes: editingProduct.product_additional_notes,
            ...
            <ManageProducts
              ...
              onView={(p: Product) => {
                setSelectedProduct({
                  ...
                  product_minimum_order_quantity: p.product_minimum_order_quantity,
