      ...
      <main className="flex-1 ml-0 lg:ml-72 min-h-screen bg-gray-50 pt-28 pb-16 sm:pt-28 lg:pt-4 lg:pb-0">
        <div className="p-3 sm:p-6 lg:p-8 max-w-7xl mx-auto">
          {activeTab !== 'home' && (
            <div className="mb-4 sm:mb-8">
              ...
              {activeTab === 'products' && "Browse and purchase recycled products."}
              ...
              <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 border border-gray-100">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mt-1">0</h3>
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 border border-gray-100">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mt-1">₹0.00</h3>
                  </div>
          ...
          <div>
              ...
              <div className="col-span-1 md:col-span-2 lg:col-span-3 bg-white rounded-xl shadow-lg p-4 sm:p-6 border border-gray-100">
                ...
                <div className="mt-6 text-center text-gray-500">
                  ...
                  <p className="mt-4 text-sm">No orders yet. Start shopping to see your orders here.</p>
                  <button
                    onClick={() => setActiveTab('products')}
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="col-span-1 bg-white rounded-xl shadow-lg p-4 sm:p-6 border border-gray-100">
                ...
                <div className="text-center py-10 sm:py-12">
                  ...
                  <h3 className="mt-4 text-base sm:text-lg font-medium text-gray-900">Products Coming Soon</h3>
                  <p className="mt-2 text-sm sm:text-base text-gray-600">
                    We&apos;re working on bringing you a great selection of recycled products.
                  </p>
                </div>
              </div>
          </div>
        ...
        {activeTab === 'profile' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 border border-gray-100 hover:scale-105 transition-transform duration-200 cursor-pointer"   onClick={() => router.push('../profile')}
>
              ...
              <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 border border-gray-100 hover:scale-105 transition-transform duration-200 cursor-pointer">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Add and manage your payment methods</p>
                  </div>
                </div>
              </div>
          ...
          <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">View your order history and receipts</p>
                  </div>
                </div>
              </div>
          </div>
      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="max-w-md w-full bg-white p-6 rounded-lg shadow-md text-center">
          ...
          <p className="text-gray-600 mb-6">
            Please complete your account verification to access the seller dashboard.
          </p>
          <button
