        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div 
              ...
              variants={fadeInUp}
            >
              <h1 className= {`text-5xl lg:text-6xl font-bold leading-tight ${isMobile ? 'text-center' : ''}`}>
              ...
              <p className="text-xl text-gray-200 leading-relaxed sm:text-left text-justify">
                At Eco-Find, we&apos;re revolutionizing the recycling industry through innovative technology 
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <p className="text-gray-600 leading-relaxed sm:text-left text-justify">{value.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-gray-700 leading-relaxed sm:text-left text-justify">
                ...
                intensified. The publication of the 2021 Intergovernmental Panel on Climate Change (IPCC) report was a wake-up
                call—it unequivocally underscored the urgency of addressing climate
                change.
              </p>
              <p className="text-base sm:text-lg text-gray-700 leading-relaxed sm:text-left text-justify">
                The Intergovernmental Panel on Climate Change (IPCC) warned that only prompt, sweeping action can keep global
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-gray-700 leading-relaxed sm:text-left text-justify">
                Our goal is to establish Eco-Find as the benchmark for sustainable
