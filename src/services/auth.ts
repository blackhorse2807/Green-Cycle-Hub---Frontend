...
export const authService = {
  companyAdminSignupOtp: async ({ mobile }: { mobile: string }): Promise<OtpResponse> => {
    try {
  ...
  companyAdminMobileSignup: async ({ mobile, otp }: { mobile: string; otp: string }): Promise<SignupResponse> => {
    try {
